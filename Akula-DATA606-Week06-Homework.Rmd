...
**_(c) Women who do not suffer from depression $\hat{p}_{no-dep}$: `r round(2607/50739,3)`. _**
**_Women who suffer from depression $\hat{p}_{dep}$: `r round(48132/50739,3)`_**
...
**_${Z^2}_{2-6 \space cups}:$ $(Observed - Expected)^2/Expected = (373 - 340)^2/340$ = `r round((373 - 340)^2/340,4)`_**
